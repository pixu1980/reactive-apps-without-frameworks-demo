      ...
      >
        ...
        <section data-slot="meta">
          ...
          <label data-field>
            ...
            <select
              model=${todoModel(todo.id, "priority", { event: "change" })}
            >
              ${priorityOptions()}
            </select>
          </label>
          <label data-field>
            ...
            <input
              model=${todoModel(todo.id, "dueDate", { event: "change" })}
              type="date"
            />
          </label>
        </section>
        ...
        <footer data-slot="footer">
          <span data-component="priority-chip" data-priority=${todo.priority}>
            ${optionLabel(language, "priority", todo.priority)}
          </span>
