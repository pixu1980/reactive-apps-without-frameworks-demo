  ...
  return html`
    ...
    >
      ...
      <menu data-list-reset data-slot="actions-grid">
        ...
        <li>
          <button data-variant="secondary" @click=${clearSelection}>
            ${t(language, "buttons.clearSelection")}
          </button>
        </li>
        <li>
          <button @click=${() => toggleAllSelected(true)}>
            ${t(language, "buttons.completeSelected")}
          </button>
        </li>
        <li>
          <button
          ...
          >
            ${t(language, "buttons.reopenSelected")}
          </button>
        </li>
        <li>
          <button data-variant="danger" @click=${deleteSelected}>
            ${t(language, "buttons.deleteSelected")}
          </button>
        </li>
        <li>
          <button data-variant="danger" @click=${deleteCompleted}>
            ${t(language, "buttons.deleteCompleted")}
          </button>
        </li>
      </menu>
    </section>
