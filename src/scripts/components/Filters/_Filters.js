    ...
    >
      ...
      <form data-slot="form" @submit=${handleFiltersSubmit}>
        <label data-field>
          ...
          <input
            model=${storeModel("filters.search")}
            placeholder=${t(language, "placeholders.search")}
          />
        </label>
        <section data-layout="pair-grid" data-slot="primary-filters">
          ...
          <label data-field>
            ...
            <select
              model=${storeModel("filters.category", { event: "change" })}
            >
              ${categoryFilterOptions()}
            </select>
          </label>
        ...
        <section data-layout="pair-grid" data-slot="secondary-filters">
          <label data-field>
            ...
            <select
              model=${storeModel("filters.priority", { event: "change" })}
            >
              ${priorityFilterOptions()}
            </select>
          </label>
